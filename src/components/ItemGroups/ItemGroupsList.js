...
import ItemGroupsListTableHeader from './ItemGroupsListTableHeader'
import ItemGroupsRowOptions from './ItemGroupsRowOptions'
import ItemGroupsFilters from './ItemGroupsFilters'
...
const ItemGroupsList = ({
  ...
  return (
    <div>
    <ItemGroupsFilters isActive={isActive} setIsActive={setIsActive} />
      <Card>
        <CardHeader title={t('item_groups')} />
        <CustomDataGrid
          toolbar={ItemGroupsListTableHeader}
          toolbarProps={{
            value: search,
