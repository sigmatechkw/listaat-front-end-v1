...
import ProjectTabsFilters from './ProjectTabsFilters'
import ProjectTabsListTableHeader from './ProjectTabsListTableHeader'
...
const ProjectTabsList = ({
  ...
  return (
    <div>
      <ProjectTabsFilters isActive={isActive} setIsActive={setIsActive} isDefault={isDefault} setIsDefault={setIsDefault}  />
      <Card>
        <CardHeader title={t('project_tabs')} />
        <CustomDataGrid
          toolbar={ProjectTabsListTableHeader}
          toolbarProps={{
            value: search,
